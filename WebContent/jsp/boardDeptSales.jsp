...
<!-- 			</div> -->
		...
		<ul id="menuBox1Ul">
				...
				<li class="menu"><a href="#">프로젝트 게시판</a>
					...
					<ul class="hide">
		                <li><a href="board_project_ongoing">진행중 프로젝트</a></li>
		                <li><a href="board_project_finished">완료된 프로젝트</a></li>
		            </ul>
			...
			<div id="menuBox2">
				...
				<p style="margin-top: 20px; margin-left: 50px;">
					<a href="#" style="font-size: 17px">영업부</a>
				</p>
