...
<body>
		...
		<div id="content">
			...
			<p style="position: absolute;margin-top:20px;margin-left: 880px">
				<a href="groupwareMainForm" style="text-decoration: none;">홈</a>&nbsp;>
				<a href="boardMainForm" style="text-decoration: none;">게시판</a>&nbsp;>
				<a href="boardNotice" style="text-decoration: none;">공지사항</a>
			</p>
			...
			<div id="menuBox2">
				...
				<p style="margin: 20px">
					<a href="#" style="font-size: 20px; display: inline-block; text-decoration: none;">공지사항</a>
				</p>
				<hr id="hr3">
					<b style="font-size: 18px">공지 수정</b>
