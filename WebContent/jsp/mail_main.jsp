...
<body>
	...
	<div id="content">
			...
			<div id="menuBox2">
			<p style="margin:20px">
				<a href="${contextPath}/mail/mail_receiveInbox_form" style="font-size: 20px;">최근 메일 목록 | 받은편지함 : 8통</a>
				
				
			</p>
			<hr id="hr3">
			<br>
				<h3><a href="${contextPath}/mail/mail_receiveInbox_form">받은편지함</a></h3>
				<br>
				<hr id="hr4">
				<br>
				<table>
				...
				<td width="400px"><a href="${contextPath}/mail/mail_receiveInbox_view_form">기획안 다시 보내주세요</a></td>
				...
				<br>
				<p style="margin:20px">
				<a href="${contextPath}/mail/mail_sendInbox_form" style="font-size: 20px;">최근 메일 목록 | 보낸편지함 : 2통</a>
				</p>
				<hr id="hr3">
				<br>
				<h3><a href="${contextPath}/mail/mail_sendInbox_form">보낸편지함</a></h3>
				<br>
				<hr id="hr4">
				<br>
				<table>
				...
				<tr>
				<td width="200px">김진수 과장</td>
				<td width="400px"><a href="${contextPath}/mail/mail_sendInbox_view_form">기획안 다시 보내주세요</a></td>
				<td width="200px">2018/7/16</td>
				</tr>			
				<tr>
				<td width="200px">김진수 과장</td>
