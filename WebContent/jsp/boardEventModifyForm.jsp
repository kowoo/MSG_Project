	...
	<ul id="menuBox1Ul">
			...
			<div id="menuBox2">
				...
				<hr id="hr3" style="margin-bottom: 10px;">
					<span><b style="font-size: 18px;">이벤트 수정</b></span><br>
							...
							<fieldset style="margin-top: 10px; border-style: none;">
								<table id="writeTable" style="margin-top: 0">
									...
									<tr id="wTtr1" style="width: 100%">
										<th style="border-bottom: 0.7px solid silver; width:100px;">제목</th>
									...
									<tr id="wTtr23">
										...
										<td colspan="2" style="border-bottom: 0.7px solid silver; text-align: left; width: 200px;">
