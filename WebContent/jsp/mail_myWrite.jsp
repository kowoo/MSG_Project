...
<body>
	...
	<div id="content">
		<p id="p_header">
			...
			<a href="mail_myWrite_form">내게메일쓰기</a>
		</p>
		<div id="menuBox1">
			<br>
		...
		<div id="menuBox2">
			<p style="margin: 20px">
				<a href="mail_myWrite_form" style="font-size: 20px;">내게메일 쓰기</a>
			</p>
			<hr id="hr3">
			<br>
			<div id="button_send" style="float: left">
				<input type="button" id="button_send_send" name="저장" value="저장">
				<input type="button" name="임시저장" value="임시저장"><a href="mail_Write_form"><img
