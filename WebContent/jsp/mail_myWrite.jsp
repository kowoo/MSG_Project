	...
	<div id="content">
		...
		<div id="menuBox1">
			...
			<ul id="menuBox1Ul">
				...
				<li><a href="${contextPath}/mail/mail_deleteInbox_form">지운편지함&nbsp;<small><a href="${contextPath}/mail/mail_delete_notice_form" style="color:red !important;">비우기</a></small></a></li><br>
			</ul>
				<hr id="hr2">
		...
		<div id="menuBox2">
			<p style="margin: 20px">
				<a href="mail/mail_myWrite_form" style="font-size: 20px;">내게메일 쓰기</a>
			</p>
			<hr id="hr3">
			<br>
			<div id="button_send" style="float: left">
				<input type="button" id="button_send_send" name="저장" value="저장">
				<input type="button" name="임시저장" value="임시저장"><a href="${contextPath}/mail/mail_Write_form"><img
