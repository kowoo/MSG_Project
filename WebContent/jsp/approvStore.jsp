...
<body>
	...
	<div id = "content">
		...
		<div id = "appbox1">
			<div id = "wait">
				<p id = "wait_title">
					<a href = "${contextPath}/page/denyDocForm" class = "bigTitle">반려 결재목록</a>
				</p>
				<ul>
					<li class = "list_li">
			...
			<div id = "req">
				<p id = "req_title">
					<a href = "${contextPath}/page/curDocForm" class = "bigTitle">진행 결재목록</a>
				</p>
				<ul>
					<li class = "list_li">
			...
			<div id = "finish">
				<p id = "finish_title">
					<a href = "${contextPath}/page/comDocForm" class = "bigTitle">완료 결재목록</a>
				</p>	
				<ul>
					<li class = "list_li">
