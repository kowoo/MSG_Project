...
<body>
	...
	<div id="content">
		...
		<div id="menuBox2">
			<p style="margin: 20px">
				<a href="#" style="font-size: 20px;">메일 전달</a>
			</p>
			<hr id="hr3">
			<br>
			<div id="button_send" style="float: left">
				...
				<input type="button" name="임시저장" value="임시저장"> <img
					src="${contextPath}/img/recycle.png"><a href="mail_myWrite_form"><small
				...
				<table>
					...
					<tr>
						...
						<td><input type="text" name="receive_title" value="기획안 제출"></td>
					</tr>
				</table>
				<hr class="hr4">
				<br>
