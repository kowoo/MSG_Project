...
<body>
	...
	<div id="content">
		...
		<div id="menuBox1">
			...
			<ul id="menuBox1Ul">
				<li class="menu"><a
					href="${contextPath }/page/ManagementRoom">회의실</a></li>

			</ul>
			<br>
			<ul id="menuBox1Ul">
				<li class="menu"><a
					href="${contextPath}/page/ManagementCar">차량</a>
			</ul>
				...
				<table>
					...
					<tr>
						...
						<td><select style="width: 170px; height: 20px;">
								...
								<option value="kfive">k5</option>
								<option value="audi">아우디</option>
						</select></td>

						<th>활성상태</th>
						<td><select style="width: 150px; height: 20px;">
								<option value="caruse">사용중</option>
								<option value="caravailable">사용가능</option>
						</select></td>
						<th>자원ID</th>
