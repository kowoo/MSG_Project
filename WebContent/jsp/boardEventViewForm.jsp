		...
		<div id="content">
			...
			<div id="menuBox2">
				...
				<p style="text-align: right; margin-top: 5px">
					<button onclick="location.href=board_dept_modify">수정하기</button>
					<button onclick="location.href=board_dept">목록보기</button>
				</p>
<!-- 					<h4 style="margin-left: 25px;">공지 작성</h4> -->
					
					<div id="viewBox">
						
						<div id="viewBoxTitle">
							<h3 style="margin-bottom:3px; margin-left: 10px; margin-top: 10px;">받아올 이벤트 제목</h3>
							<ul>
								<li>작성자</li>
								<li>2018.7.17.화</li>
