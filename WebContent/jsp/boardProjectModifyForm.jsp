...
<body>
		...
		<hgroup id="title"> 
			...
			<nav id="main_lnb">
				<ul id="ul1">
					<li><a href="boardMain" style="text-decoration: none;">게시판</a></li>
		...
		<div id="content">
			...
			<p style="position: absolute;margin-top:20px;margin-left: 880px">
				<a href="groupwareMaainForm">홈</a>&nbsp;>
				<a href="boardMainForm">게시판</a>&nbsp;>
				<a href="boardProject">프로젝트 게시판</a>
			</p>
			...
			<div id="menuBox2">
				...
				<p style="margin: 20px">
					<a href="#" style="font-size: 20px; display: inline-block; text-decoration: none;">프로젝트 게시판</a>
				</p>
							...
							<fieldset style="margin-top: 10px; border-style: none;">
								<table id="writeTable" style="margin-top: 0">
									...
									<tr>
										...
										<th rowspan="2" style="width: 100px; border-bottom: 1px solid silver; border-right: 1px solid silver">프로젝트 기간</th>
										
										<th colspan="1"  style="border-bottom: 1px solid silver; width: 80px;">시작일</th>
										<td colspan="3" style="border-bottom: 1px solid silver" align="left">
											<select>
												<option>2018년</option>
											</select>
											<select>
									...
									<tr>
										<td colspan="1" style="border-bottom: 1px solid silver; font-weight: bolder; width: 50px;">마감일</td>
										<td colspan="2" style="border-bottom: 1px solid silver;" align="left">
											<select>
												<option>2018년</option>
											</select>
											<select>
