...
<body>
		...
		<hgroup id="title"> 
			...
			<nav id="main_lnb">
				<ul id="ul1">
					<li><a href="${contextPath}/board/boardMain" style="text-decoration: none;">게시판</a></li>
		...
		<div id="content">
			...
			<div id="menuBox2">
				...
				<p style="margin: 20px">
					<a href="${contextPath}/board/boardMainForm" style="font-size: 20px; display: inline-block; text-decoration: none;">프로젝트 게시판</a>
				</p>
