...
<!-------------------------------------헤더--------------------------------------------------------->
		<div id="content">
			...
			<a href="group_Main">홈</a>&nbsp;>
				...
				<a href="mail_receiveInbox_form">받은편지함</a>
				<a href="mail_receiveInbox_view_form">상세보기</a>
			</p>
			<div id="menuBox1">
			<br>
			...
			<hr id="hr3">
				...
				<div id="button_send2" >
				<br>
				<label>보내는사람 : 이준성 사원</label><br>
				<label>받는사람 : 김진수 과장  </label><br>
				...
				<br>
				<label>첨부파일 </label><br>
				<img src="${contextPath}/img/download.png">&nbsp;<label>기획안(1차).ppt</label>
		</div>
