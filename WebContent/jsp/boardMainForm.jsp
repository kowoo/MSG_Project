	...
	<div id="content">
		...
		<div id="menuBox2">
			...
			<p style="margin-bottom: 10px; margin-top: 30px;">
				<a href="${contextPath}/board/boardNotice" style="font-size: 15px; margin-left: 50px;">전체공지</a>
				<a href="${contextPath}/board/boardNotice" style="margin-left: 560px; font-weight: normal; font-size: 12px; text-decoration: underline;">더보기</a>
			</p>
			...
			<div style=" width: 800px; height: 200px; position: absolute; margin-top: 150px;">
				...
				<p style="margin: 20px; margin-bottom: 10px; margin-top: 20px;">
					<a href="${contextPath}/board/boardEvent" style="font-size: 15px; margin-left: 35px;">EVENT</a>
					<a href="${contextPath}/board/boardEvent" style="margin-left: 575px; font-weight: normal; font-size: 12px; text-decoration: underline;">더보기</a>
				</p>
