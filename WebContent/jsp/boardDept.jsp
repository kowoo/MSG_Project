...
<body>
	...
	<div id = "content">
		...
		<div id = "menuBox2">
			...
			<hr id = "hr3">
			<hr id = "hr4" style="margin-top: 650px;">
		</div>
		...
		<div id = "appbox1">
			...
			<div id = "salesDept">
				<p id = "salesDept_title">
				<a href = "#">영업부</a>
				<a href = "#" class="salesdept_a">더보기</a>
				</p>
				<ul>
					<li style = "padding : 10px; margin-bottom : 20px;">
						<span class = "title"><strong>내용1</strong></span><span class = "date">2018.06.12</span>
			...
			<div id="ministryDept">
				...
				<a href = "#">재무부</a>
				<a href = "#" class="ministrydept_a">더보기</a>
				</p>
