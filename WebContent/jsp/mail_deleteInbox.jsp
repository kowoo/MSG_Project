...
<!-------------------------------------헤더--------------------------------------------------------->
		<div id="content">
			...
			<div id="menuBox2">
			<p style="margin:20px">
				<a href="${contextPath}/mail/mail_deleteInbox_form" style="font-size: 20px;">최근 메일 목록 | 지운편지함</a>
			...
			<br>
				...
				<td width="400px"><a href="${contextPath}/mail/mail_deleteInbox_view_form">기획안 다시 보내드립니다~~</a></td>
