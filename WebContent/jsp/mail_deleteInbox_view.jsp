...
<!-------------------------------------헤더--------------------------------------------------------->
		<div id="content">
			<p id="p_header2">
				...
				<a href="mail_deleteInbox_form">지운편지함</a>&nbsp;>
				<a href="mail_deleteInbox_view_form">상세보기</a>
			</p>
			<div id="menuBox1">
			<br>
			...
			<div id="menuBox2">
			<p style="margin:20px">
				<a href="mail_deleteInbox_view_form" style="font-size: 20px;">지운편지함</a>	
			</p>
			<hr id="hr3">
				<div id="button_send1">
				<input type="button" name="영구삭제" value="영구삭제" id="mail_everlasting_delete_view">
				</div>
				<div id="button_send2">
				<br>
