...
<!-------------------------------------헤더--------------------------------------------------------->
		<div id="content">
			...
			<ul id="menuBox1Ul">
				...
				<li><a href="${contextPath}/mail/mail_deleteInbox_form">지운편지함&nbsp;<small><a href="${contextPath}/mail_delete_notice_form" style=color:red;>비우기</a></small></a></li><br>
			</ul>
				<hr id="hr2">
			...
			<div id="menuBox2">
			<p style="margin:20px">
				<a href="${contextPath}/mail/mail_draftsInbox_view_form" style="font-size: 20px;">임시보관함</a>	
			</p>
			<hr id="hr3">
				<div id="button_send1">
